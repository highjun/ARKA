...
ADR 0006·0007·0009·0010·0014·0015가 인용하는 `§4`·`§5`·`§6`·`§8`·`§16`은 이 저장소 밖에 있는 원본 아키텍처 결정 문서(사용자가 보관, "ADE — 아키텍처 결정 문서")의 절 번호다. 그 문서는 리포에 넣지 않는다 — 한 번 통째로 넣었다가 리뷰 불가로 롤백한 전례가 있고, 결정의 요지는 각 ADR이 스스로 담고 있다. 대응은 다음과 같다.
