...
import type { ChangeEvent, ComponentPropsWithoutRef, KeyboardEvent, Ref } from "react";
...
export interface InputComposerProps extends Omit<ComponentPropsWithoutRef<"form">, "children" | "onSubmit"> {
  /** 루트 `form`으로 그대로 통과한다. */
