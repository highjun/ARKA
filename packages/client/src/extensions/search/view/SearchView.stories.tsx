...
const withViewModel = (state: Partial<ISearchViewModel>) => {
  ...
  container.register(SearchViewModelToken, singleton(() => viewModel(state)));
...
export const OptionsOn: Story = story({ query: 'Search.*View', regex: true, caseSensitive: true, summary: '1개 파일에서 1개' });
