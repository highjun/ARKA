...
export const createWorkspaceMarkdownSource = (ports: {
  files: MarkdownFileReader;
  watch: MarkdownDirectoryWatcher;
}): IMarkdownSource => new WorkspaceMarkdownSourceAdapter(ports);
