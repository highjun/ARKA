 ...
 *  갈라진다. */
export type IconButtonRootProps = PrimerIconButtonProps;
 ...
 */
const Root = forwardRef<HTMLButtonElement, IconButtonRootProps>((props, ref) => (
  <PrimerIconButton
    {...props}
    ref={ref}
...
Root.displayName = 'IconButton';

export type { IconButtonRootProps as IconButtonProps };
export const IconButton = assembleCompound('IconButton', Root, {});
