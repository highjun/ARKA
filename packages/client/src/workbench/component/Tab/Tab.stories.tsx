...
const ITEMS: readonly TabGroupItem[] = [
  ...
  { id: 'main', title: 'main.ts', iconId: 'fileCode', isDirty: true, content: <div style={{ padding: 16 }}>main.ts 내용</div> },
  { id: 'preview', title: 'notes.md', iconId: 'file', isPreview: true, content: <div style={{ padding: 16 }}>미리보기 탭</div> },
];
